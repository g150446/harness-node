 ...
 * PDM Microphone via Zephyr DMIC API on nRF54L15
 *
 * Ported from nordic-main/src/audio_capture.c:
 *   - DT alias: dmic0 → dmic20
 *   - Fallback node: pdm0 → pdm20
 *   - PDM channel: PDM_CHAN_RIGHT → PDM_CHAN_LEFT
 */
